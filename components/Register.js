...
import { signupUser, userSelector , clearState, loginUser ,CreateUser } from '../slices/userSlice';
import { ActivityIndicator } from 'react-native';
import { Alert } from 'react-native';
import { getStations } from '../slices/locationReducer';
...
const Register = props => {
    ...
    useEffect(() => {
      ...
      const Login = async (data) => {
        console.log("onsubmit data",data)
       const res =  dispatch(loginUser( await data));
    };
